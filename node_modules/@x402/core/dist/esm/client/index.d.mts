import { a as PaymentRequired, aq as x402Client, P as PaymentPayload, S as SettleResponse } from '../x402Client-pTJv8yPe.mjs';
export { av as AfterPaymentCreationHook, au as BeforePaymentCreationHook, aC as ClientExtension, aA as ClientExtensionHooks, aB as ClientTransportExtensionHooks, aE as DEFAULT_MAX_AMOUNT_PER_PAYMENT, aw as OnPaymentCreationFailureHook, ay as OnPaymentResponseHook, as as PaymentCreatedContext, ar as PaymentCreationContext, at as PaymentCreationFailureContext, aD as PaymentPolicy, ax as PaymentResponseContext, aH as SchemeRegistration, az as SelectPaymentRequirements, aF as SpendControlAsset, aG as SpendControls, aI as x402ClientConfig } from '../x402Client-pTJv8yPe.mjs';
...
declare class x402HTTPClient {
     ...
     */
    handlePaymentRequired(paymentRequired: PaymentRequired, requestUrl: string): Promise<Record<string, string> | null>;
    /**
