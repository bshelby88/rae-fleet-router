...
import { ProtectedRequestHook, PaymentRequiredContext } from '@x402/core/http';
 ...
 */
type SIWxValidationCode = "invalid_siwx_domain_mismatch" | "invalid_siwx_uri_mismatch" | "invalid_siwx_issued_at" | "invalid_siwx_issued_at_too_old" | "invalid_siwx_issued_at_in_future" | "invalid_siwx_expiration_time" | "invalid_siwx_expired" | "invalid_siwx_not_before" | "invalid_siwx_not_yet_valid" | "invalid_siwx_nonce";
/**
 ...
 */
type SIWxVerifyCode = "invalid_siwx_signature" | "invalid_siwx_chain_id" | "invalid_siwx_unsupported_chain" | "invalid_siwx_malformed_signature" | "invalid_siwx_verifier_error";
/** All spec-documented SIWx failure codes (validation and verify). */
type SIWxErrorCode = SIWxValidationCode | SIWxVerifyCode;
/**
 ...
 */
declare function assertSIWxChallengeBoundToOrigin(info: SIWxExtensionInfo, responseUrl: string | URL): void;
/**
 ...
 * ```
 */
declare function createSIWxPayload(serverExtension: CompleteSIWxInfo, signer: SIWxSigner, requestUrl: string | URL): Promise<SIWxPayload>;
 ...
 */
interface CreateSIWxSettleHookOptions {
 ...
 */
interface CreateSIWxRequestHookOptions extends CreateSIWxSettleHookOptions {
    /**
...
type CreateSIWxHookOptions = CreateSIWxRequestHookOptions;
/**
 ...
 * ```
 */
declare function createSIWxSettleHook(options: CreateSIWxSettleHookOptions): (ctx: {
    paymentPayload: {
        payload: unknown;
        resource?: {
            url: string;
 ...
 * ```
 */
declare function createSIWxRequestHook(options: CreateSIWxRequestHookOptions): ProtectedRequestHook;
/**
 ...
 * ```
 */
declare function createSIWxClientHook(signer: SIWxSigner): (context: PaymentRequiredContext) => Promise<{
 ...
 */
type CreateSIWxResourceServerExtensionOptions = CreateSIWxRequestHookOptions;
/**
 ...
 * ```
 */
declare function validateSIWxMessage(message: SIWxPayload, expectedOrigin: URL, options?: SIWxValidationOptions): Promise<SIWxValidationResult>;
...
export { type CompleteSIWxInfo, type CreateSIWxClientExtensionOptions, type CreateSIWxHookOptions, type CreateSIWxRequestHookOptions, type CreateSIWxResourceServerExtensionOptions, type CreateSIWxSettleHookOptions, type DeclareSIWxOptions, type EVMMessageVerifier, type EVMSigner, InMemorySIWxStorage, SIGN_IN_WITH_X, type SIWxErrorCode, type SIWxExtension, type SIWxExtensionInfo, type SIWxExtensionSchema, type SIWxHookEvent, type SIWxPayload, SIWxPayloadSchema, type SIWxSigner, type SIWxStorage, type SIWxValidationCode, type SIWxValidationOptions, type SIWxValidationResult, type SIWxVerifyCode, type SIWxVerifyOptions, type SIWxVerifyResult, SOLANA_DEVNET, SOLANA_MAINNET, SOLANA_TESTNET, type SignatureScheme, type SignatureType, type SolanaSigner, type SupportedChain, assertSIWxChallengeBoundToOrigin, buildSIWxSchema, createSIWxClientExtension, createSIWxClientHook, createSIWxMessage, createSIWxPayload, createSIWxRequestHook, createSIWxResourceServerExtension, createSIWxSettleHook, declareSIWxExtension, decodeBase58, encodeBase58, encodeSIWxHeader, extractEVMChainId, extractSolanaChainReference, formatSIWEMessage, formatSIWSMessage, getEVMAddress, getSolanaAddress, isEVMSigner, isSolanaSigner, parseSIWxHeader, signEVMMessage, signSolanaMessage, validateSIWxMessage, verifyEVMSignature, verifySIWxSignature, verifySolanaSignature, wrapFetchWithSIWx };
