...
async function processPaymentResponse(storage, getHeader, local) {
  ...
  const channelState = settle.extra?.channelState;
...
//# sourceMappingURL=chunk-F466B4B6.mjs.map