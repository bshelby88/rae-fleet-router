...
var BatchSettlementEvmScheme = class {
  ...
  async parsePrice(price, network) {
    ...
    const { amount, symbol } = (0, import_utils13.parseMoney)(price);
  ...
  createChannelManager(facilitator, network, token) {
    const resolvedToken = token ?? getDefaultAsset(network).asset;
  ...
  defaultMoneyConversion(amount, network, symbol) {
    ...
    const tokenAmount = (0, import_utils13.convertToTokenAmount)(amount, assetInfo.decimals);
